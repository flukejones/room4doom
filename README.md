...
The original Linux Doom source as licensed under the DSL is being used as an
educational resource as stated under clause 2 of the DSL to enable a rewrite of the
source under **MPL**.

Portions of the "Source Code" which is the "Linux Doom Source Code" may appear in the
source in this repository but the "Source Code" is not duplicated as a whole. These
portions are translated and the end result often bares little resemblance
to said portions except where portion is of such generic code flow there is little
other way to write it.

Where possible, relevant comments in the "Source Code" are kept  as historical artifacts.
