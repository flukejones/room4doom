...
/// Check if a sector has movable properties
fn is_movable_sector(sector: &Sector) -> bool {
    // Check for door, lift, or other movable sector types
    match sector.special {
        // Door types
        1 | 26 | 27 | 28 | 31 | 32 | 33 | 34 | 117 | 118 => true,
        // Lift types
        10 | 21 | 22 | 47 | 53 | 62 | 88 | 95 | 120 | 121 | 122 | 123 => true,
        // Ceiling types
        40 | 41 | 43 | 44 | 49 | 72 | 73 | 74 | 83 => true,
        // Floor types
        18 | 19 | 20 | 23 | 36 | 37 | 38 | 45 | 46 | 69 | 70 | 71 | 98 | 158 => true,
        _ => false,
    }
}
