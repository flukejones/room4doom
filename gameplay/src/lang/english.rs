...
pub const PD_BLUEC: &str = "You need a blue card to open this door";
pub const PD_REDC: &str = "You need a red card to open this door";
pub const PD_YELLOWC: &str = "You need a yellow card to open this door";
pub const PD_BLUES: &str = "You need a blue skull to open this door";
pub const PD_REDS: &str = "You need a red skull to open this door";
pub const PD_YELLOWS: &str = "You need a yellow skull to open this door";
pub const PD_ANY: &str = "You need a key to open this door";
pub const PD_ALL3: &str = "You need all three keys to open this door";
pub const PD_ALL6: &str = "You need all six keys to open this door";
...
// Options menu
pub const OPT_TITLE: &str = "OPTIONS";

pub const OPT_SOUND: &str = "SOUND..";
pub const OPT_SFX_VOL: &str = "SFX VOLUME";
...
pub const OPT_MODE_WINDOWED: &str = "WINDOWED";
pub const OPT_MODE_BORDERLESS: &str = "BORDERLESS";
pub const OPT_MODE_EXCLUSIVE: &str = "EXCLUSIVE";
pub const OPT_VSYNC: &str = "VSYNC";

pub const OPT_GRAPHICS: &str = "GRAPHICS..";
pub const OPT_RENDERER: &str = "RENDERER";
#[cfg(feature = "software25d")]
pub const OPT_REND_CLASSIC: &str = "CLASSIC";
#[cfg(feature = "software3d")]
pub const OPT_REND_SOFT3D: &str = "SOFTWARE 3D";
#[cfg(feature = "wgpu3d")]
pub const OPT_REND_HARD3D: &str = "HARDWARE 3D";
#[cfg(feature = "wgpu3dbsp")]
pub const OPT_REND_HARD3DBSP: &str = "HARDWARE 3D BSP";
pub const OPT_FRAME_INTERP: &str = "INTERPOLATION";
#[cfg(feature = "wgpu3d")]
pub const OPT_DYNAMIC_SKY: &str = "DYNAMIC SKY";
pub const OPT_VOXELS: &str = "VOXELS";
pub const OPT_CRT_GAMMA: &str = "CRT GAMMA";
pub const OPT_LIGHT_GAMMA: &str = "LIGHT GAMMA";
pub const OPT_SHOW_FPS: &str = "SHOW FPS";
pub const OPT_HEALTH_BLEED: &str = "HEALTH BLEED";
pub const OPT_MENU_DIM: &str = "DIM MENU BG";
pub const OPT_END_GAME: &str = "END GAME";
pub const OPT_MESSAGES: &str = "MESSAGES";
pub const OPT_DETAIL: &str = "GRAPHIC DETAIL";
pub const OPT_DETAIL_HIGH: &str = "HIGH";
pub const OPT_DETAIL_LOW: &str = "LOW";

pub const OPT_INPUT: &str = "INPUT SETUP..";
pub const OPT_MOUSE_SENS: &str = "MOUSE SENSITIVITY";
pub const OPT_INVERT_Y: &str = "INVERT Y AXIS";

pub const OPT_HUD: &str = "HUD SETUP..";
pub const OPT_HUD_SIZE: &str = "SIZE";
pub const OPT_HUD_SIZE_FULL: &str = "FULLSCREEN";
pub const OPT_HUD_SIZE_BAR: &str = "STATUSBAR";
pub const OPT_HUD_WIDTH: &str = "WIDTH";
pub const OPT_HUD_WIDTH_CLASSIC: &str = "CLASSIC";
pub const OPT_HUD_WIDTH_WIDE: &str = "WIDESCREEN";
pub const OPT_HUD_MSG_MODE: &str = "MESSAGES";
pub const OPT_HUD_MSG_OFF: &str = "OFF";
pub const OPT_HUD_MSG_STACK: &str = "STACK";
pub const OPT_HUD_MSG_OVER: &str = "OVERWRITE";
pub const OPT_HUD_MSG_TIME: &str = "MSG TIME";

pub const OPT_APPLY: &str = "APPLY";
pub const OPT_ON: &str = "ON";
pub const OPT_OFF: &str = "OFF";
pub const OPT_RESTART: &str = "RESTART REQUIRED";
