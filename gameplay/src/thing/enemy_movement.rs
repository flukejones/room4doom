...
impl MapObject {
    ...
    pub(crate) fn do_enemy_move(&mut self) -> bool {
        ...
        try_move.x += fixed_to_float(self.info.speed * DIR_XSPEED[self.movedir as usize]);
        try_move.y += fixed_to_float(self.info.speed * DIR_YSPEED[self.movedir as usize]);
