...
pub struct SubSectorMinMax {
    ...
    pub max_ceil_z: f32,
    pub max_dropoff: f32,
    pub sky_line: Option<MapPtr<LineDef>>,
    pub spec_hits: Vec<MapPtr<LineDef>>,
}
    ...
    fn pit_check_thing(
            ...
            && self.player().is_some()
        {
            ...
            if self.xyz.z + 0.0 >= thing_top_z {
                ...
                return true;
            } else if self.xyz.z < thing_top_z && self.xyz.z > thing.xyz.z {
                // prevent gravity sinking us in
                self.xyz.z = thing_top_z;
                self.momxyz.z = 0.0;
                return true;
            }
