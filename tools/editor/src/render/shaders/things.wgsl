// Instanced things: a billboard quad (upright in 3D, flat in top-down) with the
// sprite, plus a top-down centre dot + radius ring editing aid.
...
fn vs_thing(
    ...
    if (cam.cam_right.w > 0.5) {
        // Upright quad facing the camera: width along the camera right axis, height
        // along world +Z, bottom edge on the floor at z.
