//! World-space framing helpers: bounding rect, grid snap, and view constants.
//! Camera transform lives on [`Camera`](super::camera3d::Camera).
...
/// Round half-away-from-zero to a multiple of `grid` (DoomEd snap).
