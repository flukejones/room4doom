...
/// Vanilla flat side (64×64); drives flat-preview raster size.
...
/// Render a wall elevation: bands top-to-bottom, textures tile per world unit.
/// Caller must [`EditorAssets::ensure_composed`] band textures first.
pub fn render_wall(
    assets: &EditorAssets,
    bands: &[WallBand],
    width_world: f32,
