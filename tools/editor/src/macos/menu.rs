//! Appends "Preferences…" (⌘,) to the native macOS app submenu.
//! Action sets a thread-local flag; a Slint timer drains it — Slint must only be touched on the main thread.
