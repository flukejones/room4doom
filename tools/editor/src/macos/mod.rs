//! macOS native integration: app-menu Preferences item ([`menu`]) and vibrant titlebar ([`window`]).
//! Deferred to a timer — the native menu/window is not built until app launch completes.
