...
impl Renderer3D {
            ...
            if bsp3d.subsector_visible(player_subsector_id, subsector_id) {
                if let Some(leaf) = bsp3d.get_subsector_leaf(subsector_id) {
                    for poly_surface in &leaf.polygons {
                        if poly_surface.is_facing_point(player_pos) {
    ...
    fn render_surface_polygon(
        ...
        for i in 0..VERT_COUNT {
            ...
            let v1_world = polygon.vertices[v1_idx];
            let v2_world = polygon.vertices[v2_idx];
        ...
        if self.screen_vertices_len >= 3 {
            ...
            let ptr = (polygon as *const SurfacePolygon as usize) as u32;
    ...
    fn calculate_tex_coords(
        ...
        match surface_kind {
            SurfaceKind::Vertical {
                ...
                let tex_width = texture.data.len() as f32;
            ...
            SurfaceKind::Horizontal {
                ...
                let tex_width = flat.data[0].len() as f32;
                let tex_height = flat.data.len() as f32;
