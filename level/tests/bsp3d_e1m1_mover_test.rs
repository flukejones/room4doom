...
///
/// Covers:
///   - Sector 14: floor mover (floor=32). Every lower-wall top vertex along the
///     sector 14 boundary must share an index with sector 14's floor polygons.
///   - Sector 26: ceiling mover (door, ceiling=0). Every upper-wall bottom
///     vertex along the sector 26 boundary must share an index with sector 26's
///     ceiling polygons.
#[test]
